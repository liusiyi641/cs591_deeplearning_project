...
def auto_eval(config, vocab, model_F, test_iters, global_step, temperature):
   ...
   # print(len(rev_output[0]))
   # print(len(rev_output[1]))
   # print(rev_output[0])   
   # print(gold_text[0])
   # print(len(gold_text[0]))
   # print(rev_output[0])
    #print(len(neg_iter))
   # print(len(rev_output[0]))
    acc_neg = evaluator.yelp_acc_0(rev_output[0])
    acc_pos = evaluator.yelp_acc_1(rev_output[1])
    bleu_neg = evaluator.self_bleu_b(gold_text[0], rev_output[0])
    bleu_pos = evaluator.self_bleu_b(gold_text[1], rev_output[1])
